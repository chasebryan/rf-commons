(function () {
  ...
  const presets = [
    ...
    {
      name: "NOAA Satellite APT",
      frequency: 137.1,
      mode: "WFM",
      span: 0.2,
      label: "137 MHz",
      tags: ["VHF", "satellite"],
      summary: "Weather satellite image audio",
    },
    {
      name: "FM Broadcast",
      frequency: 99.5,
    ...
    },
    {
      ...
      label: "121.500 MHz",
      tags: ["VHF", "air"],
      summary: "Aviation emergency guard",
    },
    {
      name: "Airband Tower",
      frequency: 124.85,
    ...
    },
    {
      ...
      label: "131.550 MHz",
      tags: ["VHF", "data"],
      summary: "Aircraft text telemetry",
    },
    {
      name: "APRS Packet",
      frequency: 144.39,
    ...
    },
    {
      ...
      label: "145.825 MHz",
      tags: ["VHF", "space"],
      summary: "Amateur packet satellite",
    },
    {
      name: "2m Simplex",
      frequency: 146.52,
      ...
      label: "146.520 MHz",
      tags: ["VHF", "ham"],
      summary: "Amateur calling channel",
    },
    {
    ...
    },
    {
      ...
      label: "160-161 MHz",
      tags: ["VHF", "voice"],
      summary: "Railroad channel starter",
    },
    {
      name: "AIS Channel A",
      frequency: 161.975,
    ...
    },
    {
      ...
      label: "462.5625 MHz",
      tags: ["UHF", "voice"],
      summary: "Local handheld radios",
    },
    {
      name: "433 ISM Devices",
      frequency: 433.92,
      mode: "DATA",
      span: 1,
      label: "433.920 MHz",
      tags: ["UHF", "data"],
      summary: "Sensors and remotes",
    },
    {
      name: "915 ISM Devices",
      frequency: 915,
      mode: "DATA",
      span: 2.4,
      label: "902-928 MHz",
      tags: ["UHF", "data"],
      summary: "Meters, sensors, LoRa",
    },
    {
      name: "ADS-B",
      frequency: 1090,
    ...
    },
    {
      ...
      label: "10.000 MHz",
      tags: ["HF", "time"],
      summary: "Time and frequency standard",
    },
    {
      ...
      label: "49/31m bands",
      tags: ["HF", "broadcast"],
      summary: "International broadcast",
    },
    {
      name: "40m Ham CW",
      frequency: 7.03,
    ...
    },
    {
      ...
      label: "28.400 MHz",
      tags: ["HF", "ham"],
      summary: "Upper-sideband calling",
    },
  ];
  ...
  const signalGuide = [
    ...
    {
      name: "NOAA Satellite APT",
      use: "Weather satellite image downlink",
      bandwidth: "~34-40 kHz",
      mode: "WFM",
      next: "Use WFM and record clean passes near 137 MHz",
      band: "vhf",
      width: "wide",
      sound: "data",
      pattern: "steady",
      tags: ["VHF", "Satellite", "Weather"],
      description: "A wide analog image signal from polar-orbit weather satellites.",
      center: 137.1,
      tolerance: 0.35,
    },
    {
    ...
    {
      name: "AIS Marine Data",
      use: "Ship position broadcasts",
      bandwidth: "~25 kHz",
      mode: "DATA",
      next: "Use an AIS decoder on 161.975 or 162.025 MHz",
      band: "vhf",
      width: "narrow",
      sound: "data",
      pattern: "bursty",
      tags: ["VHF", "Marine", "Data"],
      description: "Packet bursts from vessel Automatic Identification System channels.",
      center: 162.025,
      tolerance: 0.08,
    },
    {
    ...
    {
      name: "Packet Satellite",
      use: "Amateur packet satellite downlink",
      bandwidth: "~12.5 kHz",
      mode: "NFM",
      next: "Wait for an overhead pass and keep the pass Doppler in mind",
      band: "vhf",
      width: "narrow",
      sound: "data",
      pattern: "bursty",
      tags: ["VHF", "Satellite", "Packet"],
      description: "Packet bursts from amateur satellites and space stations.",
      center: 145.825,
      tolerance: 0.08,
    },
    {
      name: "Marine VHF Voice",
      use: "Marine safety and working channels",
      bandwidth: "~12.5-25 kHz",
      mode: "NFM",
      next: "Start with channel 16, then check local marine channel plans",
      band: "vhf",
      width: "narrow",
      sound: "voice",
      pattern: "bursty",
      tags: ["VHF", "Marine", "Voice"],
      description: "Narrowband FM voice in the marine VHF service.",
      center: 156.8,
      tolerance: 0.15,
    },
    {
      name: "Railroad Voice",
      use: "Railroad operations voice",
      bandwidth: "~12.5-25 kHz",
      mode: "NFM",
      next: "Use NFM and scan the local AAR channel plan",
      band: "vhf",
      width: "narrow",
      sound: "voice",
      pattern: "bursty",
      tags: ["VHF", "NFM", "Voice"],
      description: "Intermittent narrowband FM voice in railroad allocations.",
      center: 160.215,
      tolerance: 0.5,
    },
    {
      name: "Amateur FM Simplex",
      use: "Local ham voice calling",
      bandwidth: "~12.5-25 kHz",
      mode: "NFM",
      next: "Try 146.520 MHz on 2m or 446.000 MHz on 70cm",
      band: "vhf",
      width: "narrow",
      sound: "voice",
      pattern: "bursty",
      tags: ["VHF", "UHF", "Ham"],
      description: "Local narrowband FM amateur voice, often intermittent.",
      centers: [146.52, 446],
      tolerance: 0.1,
    },
    {
      name: "FRS/GMRS Voice",
      use: "Local handheld radios",
      bandwidth: "~12.5 kHz",
      mode: "NFM",
      next: "Use NFM and low gain if the transmitter is nearby",
      band: "uhf",
      width: "narrow",
      sound: "voice",
      pattern: "bursty",
      tags: ["UHF", "NFM", "Voice"],
      description: "Short-range handheld radio channels in the 462/467 MHz range.",
      center: 462.5625,
      tolerance: 0.08,
    },
    {
    ...
    {
      name: "Aviation Data",
      use: "Aircraft text telemetry",
      bandwidth: "~12.5-25 kHz",
      mode: "AM/DATA",
      next: "Use AM audio with an ACARS decoder",
      band: "air",
      width: "narrow",
      sound: "data",
      pattern: "bursty",
      tags: ["VHF", "AM", "Data"],
      description: "Short aircraft data bursts on VHF airband data channels.",
      center: 131.55,
      tolerance: 0.15,
    },
    {
      name: "VOR Navigation",
      use: "Aviation navigation beacon",
      bandwidth: "~10-20 kHz",
      mode: "AM",
      next: "Listen for the station identifier tone",
      band: "vhf",
      width: "narrow",
      sound: "tone",
      pattern: "steady",
      tags: ["VHF", "Air", "Beacon"],
      description: "Aviation navigation signal below the voice airband.",
      center: 113,
      tolerance: 5,
    },
    {
    ...
    {
      name: "CB AM Voice",
      use: "Citizen band AM voice",
      bandwidth: "~6-10 kHz",
      mode: "AM",
      next: "Use AM and expect short-range groundwave activity",
      band: "hf",
      width: "narrow",
      sound: "voice",
      pattern: "bursty",
      tags: ["HF", "AM", "Voice"],
      description: "AM voice around the 27 MHz citizen band channels.",
      center: 27.185,
      tolerance: 0.03,
    },
    {
      name: "WWV Time Signal",
      use: "Time and frequency standard",
      bandwidth: "~5-10 kHz",
      mode: "AM",
      next: "Try 5, 10, or 15 MHz depending on propagation",
      band: "hf",
      width: "narrow",
      sound: "tone",
      pattern: "steady",
      tags: ["HF", "Time", "AM"],
      description: "A steady AM time signal with tones and voice announcements.",
      centers: [2.5, 5, 10, 15, 20],
      tolerance: 0.03,
    },
    {
      name: "ISM Data",
      use: "Sensors, remotes, meters, LoRa-style activity",
      bandwidth: "~10 kHz-1 MHz",
      mode: "DATA",
      next: "Use a wider span and look for short bursts",
      band: "uhf",
      width: "pulse",
      sound: "data",
      pattern: "bursty",
      tags: ["UHF", "ISM", "Data"],
      description: "Short bursts from unlicensed-device bands such as 433 and 915 MHz.",
      centers: [433.92, 915],
      tolerance: 1.5,
    },
  ];
  ...
  function scoreGuide(input) {
    return signalGuide
      .map((signal) => {
        ...
        if (hasFrequencyMatch(input.frequency, signal)) score += 6;
        return { ...signal, score };
      })
      .sort((a, b) => b.score - a.score);
  }

  function hasFrequencyMatch(frequency, signal) {
    const centers = Array.isArray(signal.centers)
      ? signal.centers
      : Number.isFinite(signal.center)
        ? [signal.center]
        : [];
    const tolerance = signal.tolerance || 0.1;
    return centers.some((center) => Math.abs(frequency - center) <= tolerance);
  }
